...
export default class OnTheAirToday extends React.Component {
    ...
    componentWillMount() {
        ...
        let url = `http://api.themoviedb.org/3/tv/on_the_air?api_key=0a85bfad58bfced1b7e4d5209aedd35b`;
    ...
    render() { 
        ...
        return (
            <div>
                <h4 className="underline">TV shows on the air today :</h4> <br/>
                <div className="row">
                    { movies }
                </div>
            </div>
